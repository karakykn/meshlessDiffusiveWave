...
df_freeport = pd.read_csv(f'../data/hydros/freeport_usgs.csv', header=None, sep='\t', skiprows=25)
df_deepDivert = pd.read_csv(f'../data/hydros/freeport_usgs.csv', header=None, sep='\t', skiprows=25)
...
df_to_save.to_csv('../segment1/geo/lateralDatas/yolo', header=None, index=False, sep=' ')
...
df_sacramentoIn = pd.read_csv(f'../data/hydros/freeport_usgs.csv', header=None, sep='\t', skiprows=25)
